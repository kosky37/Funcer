...
public class ResultMapTests_Task
{
    ...
    public static IEnumerable<object[]> TaskTestData2 => 
        new List<object[]>
        {
            new object[] { Results.Tasks.Success.Nothing, Tasks.Returns.Success.Alpha1, Values.Alpha1, Assertions.ValueResultSuccess },
            new object[] { Results.Tasks.Success.Nothing, Tasks.Returns.Failure.Alpha, Values.Alpha1, Assertions.ValueResultFailure },
            new object[] { Results.Tasks.Failure.Nothing, Tasks.Returns.Success.Alpha1, Values.Alpha1, Assertions.ValueResultFailure },
            new object[] { Results.Tasks.Failure.Nothing, Tasks.Returns.Failure.Alpha, Values.Alpha1, Assertions.ValueResultFailure },
        };
    ...
    public static IEnumerable<object[]> TaskTestData4 => 
        new List<object[]>
        {
            new object[] { Results.Tasks.Success.Nothing, Tasks.Returns.Alpha1, Values.Alpha1, Assertions.ValueResultSuccess },
            new object[] { Results.Tasks.Failure.Nothing, Tasks.Returns.Alpha1, Values.Alpha1, Assertions.ValueResultFailure }
        };
