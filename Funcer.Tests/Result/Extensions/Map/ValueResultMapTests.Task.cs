...
public class ValueResultMapTests_Task
{
    ...
    {
        { TestResult.Alpha.Async.Success.V1, AsyncFunc.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultSuccess },
        { TestResult.Alpha.Async.Success.V1, AsyncFunc.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Alpha.Async.Failure, AsyncFunc.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Alpha.Async.Failure, AsyncFunc.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
    };
    ...
    {
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultSuccess },
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Beta.Async.Failure, AsyncFunc.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Beta.Async.Failure, AsyncFunc.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
    };
    ...
    {
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Takes.Beta.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultSuccess },
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Takes.Beta.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Beta.Async.Failure, AsyncFunc.Takes.Beta.Returns.Success.Alpha1, TestValues.Alpha1, Assertions.ValueResultFailure },
        { TestResult.Beta.Async.Failure, AsyncFunc.Takes.Beta.Returns.Failure.Alpha, TestValues.Alpha1, Assertions.ValueResultFailure },
    };
    ...
    {
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Returns.Alpha1, TestValues.Alpha1, Assertions.ValueResultSuccess },
        { TestResult.Beta.Async.Failure, AsyncFunc.Returns.Alpha1, TestValues.Alpha1, Assertions.ValueResultFailure }
    };
    ...
    {
        { TestResult.Beta.Async.Success.V1, AsyncFunc.Takes.Beta.Returns.Alpha1, TestValues.Alpha1, Assertions.ValueResultSuccess },
        { TestResult.Beta.Async.Failure, AsyncFunc.Takes.Beta.Returns.Alpha1, TestValues.Alpha1, Assertions.ValueResultFailure }
    };
