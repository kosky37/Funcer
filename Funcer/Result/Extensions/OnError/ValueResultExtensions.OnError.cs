...
{
    public static Result<TValue> OnError<TValue>(this Result<TValue> result, string errorType,
    ...
    public static Result<TValue> OnError<TValue>(this Result<TValue> result, string errorType, Func<IEnumerable<ErrorMessage>, TValue> onError)
    {
        if (result.IsSuccess) return result;
    ...
    public static Result<TValue> OnError<TValue>(this Result<TValue> result, string errorType, Func<Result<TValue>> onError)
    {
        if (result.IsSuccess) return result;
    ...
    public static Result<TValue> OnError<TValue>(this Result<TValue> result, string errorType, Func<TValue> onError)
    {
        if (result.IsSuccess) return result;
