...
{
    public static async Task<Result> OnError(this Result result, string errorType, Func<IEnumerable<ErrorMessage>, Task> onError)
    {
    ...
    public static async Task<Result> OnError(this Result result, string errorType, Func<Task> onError)
    {
        if (result.IsSuccess) return result;
    ...
    public static async Task<Result> OnError(this Result result, string errorType, Func<IEnumerable<ErrorMessage>, Task<Result>> onError)
    {
        if (result.IsSuccess) return result;
    ...
    public static async Task<Result> OnError(this Result result, string errorType, Func<Task<Result>> onError)
    {
        if (result.IsSuccess) return result;
