...
public static partial class ValueResultExtensions
{
    ...
    {
        public async Task Resolve(Func<TValue, Task> onSuccess, Func<IEnumerable<ErrorMessage>, Task> onFailure)
        {
        ...
        public async Task Resolve(Func<TValue, Task> onSuccess, Action<IEnumerable<ErrorMessage>> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Action<TValue> onSuccess, Func<IEnumerable<ErrorMessage>, Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, IEnumerable<WarningMessage>, Task> onSuccess, Func<IEnumerable<ErrorMessage>, Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, IEnumerable<WarningMessage>, Task> onSuccess, Action<IEnumerable<ErrorMessage>> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Action<TValue, IEnumerable<WarningMessage>> onSuccess, Func<IEnumerable<ErrorMessage>, Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, Task> onSuccess, Func<Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, Task> onSuccess, Action onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Action<TValue> onSuccess, Func<Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, IEnumerable<WarningMessage>, Task> onSuccess, Func<Task> onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Func<TValue, IEnumerable<WarningMessage>, Task> onSuccess, Action onFailure)
        {
            var result = await resultTask;
        ...
        public async Task Resolve(Action<TValue, IEnumerable<WarningMessage>> onSuccess, Func<Task> onFailure)
        {
            var result = await resultTask;
